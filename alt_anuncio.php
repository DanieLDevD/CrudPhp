    ...
    <body>
        <div class="container">
            ...
            <form action="processa_anuncio.php" method="post">
                ...
                <input type="text" name="nomecliente" id="nomecliente" class="form-control" value="<?php echo $result['nomecliente']; ?>">
                </div>

                <div class="col-4">
                <label for="sobrenomecliente">Sobre Nome</label>
                <input type="text" name="sobrenomecliente" id="sobrenomecliente" class="form-control" value="<?php echo $result['sobrenomecliente']; ?>">
                </div>

                <div class="col-4">
                <label for="cpf">CPF</label>
                <input type="number" name="cpf" id="cpf" class="form-control" value="<?php echo $result['cpf']; ?>">
                </div><br>
